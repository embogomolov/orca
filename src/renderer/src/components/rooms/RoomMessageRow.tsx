...
export function RoomMessageRow({
  ...
  if (isUser) {
    return (
      <div className="group flex w-full flex-col items-end justify-end gap-1 px-3">
        <div className="flex w-full items-center justify-end gap-1">
          {!message.deletedAt ? (
            <div className="flex items-center gap-0.5 opacity-0 transition-opacity group-hover:opacity-100 group-focus-within:opacity-100">
              ...
              <NativeChatCopyButton text={message.body} />
            </div>
          ) : null}
          <div className="max-w-[77%]">
            {editing ? (
              ...
              <p className="rounded-2xl bg-muted px-3 py-2 text-sm italic text-muted-foreground">
  ...
  return (
    ...
    >
      ...
      <div className="mt-1.5 flex h-5 items-center justify-start gap-0.5 opacity-0 transition-opacity group-hover:opacity-100 group-focus-within:opacity-100">
        {!message.deletedAt ? <NativeChatCopyButton text={message.body} /> : null}
        <MessageAction
          type="button"
          onClick={() =>
          ...
          className={cn(
            'flex size-6 items-center justify-center rounded-md hover:bg-accent hover:text-foreground',
            pin
              ? pin.status === 'done'
